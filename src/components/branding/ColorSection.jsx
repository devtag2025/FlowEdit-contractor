  ...
  return (
    <Card className="bg-tertiary rounded-2xl">
      <CardContent className="flex flex-col gap-5">
        ...
        <div className="flex gap-1 md:gap-4 flex-wrap">
          {colors.map((color) => (
            <div key={color} className="flex flex-col items-center gap-3">
              <div
                className="w-12 md:w-35 aspect-square rounded-lg cursor-pointer hover:scale-105 transition"
        ...
        <div>
          <Button className="flex items-center gap-2 bg-pink-200 px-4 py-2 rounded-lg font-bold text-blue-500 text-xs md:text-base">
