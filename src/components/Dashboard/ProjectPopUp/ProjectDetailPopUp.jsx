        ...
        <div className="flex items-center justify-between text-sm">
          ...
          <div className="flex gap-2">
            <Button
              variant="ghost"
              size="sm"
              className="text-accent hover:bg-accent/5 gap-2 h-8"
            >
        ...
        <div className="pt-4 ">
          <div className="relative">
            ...
            <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1">
              ...
              >
                <Paperclip className="w-4 h-4 text-accent/60" />
              </button>
              <button
          ...
          >
            <Button
              variant="ghost"
              className="text-primary hover:bg-primary/10 hover:text-tertiary w-full"
            >
              See Project Details <MoveUpRight/>
            </Button>
            </Link>
